...
Este documento apresenta os requisitos funcionais e não funcionais da landing page "Análise do Mercado de Tecnologia".
...
| RF06   | Listar vagas locais                     | A página deve apresentar pelo menos quatro vagas locais com cargo, empresa/fonte e tecnologias exigidas.               |
| RF07   | Listar vagas nacionais                  | A página deve apresentar pelo menos quatro vagas nacionais com cargo, empresa/fonte e tecnologias exigidas.            |
...
| RC02   | Dados mínimos de vaga            | Cada vaga deve apresentar cargo, empresa/fonte e tecnologias exigidas.                |
